      ...
      if($mobile_exists->num_rows() > 0 && $this->input->post('cand_mobile')) {
        ...
        if($email_exists->num_rows() > 0) {
          ...
          $profile_update_data = array( 
                              ...
                              'candidate_set_exam_status' => ($this->input->post('cand_set_status')) ? $this->input->post('cand_set_status') : NULL,
                              'candidate_net_exam_status' => ($this->input->post('cand_net_status')) ? $this->input->post('cand_net_status') : NULL,
