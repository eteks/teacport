					...
					<?php echo form_open_multipart('provider/dashboard/editprofile', 'id="provider_editprofile" class="form-horizontal provider-profile-edit provider_form"'); ?>
						...
						<div class="row-form">
							...
							<div class="form-group">
								<label class="col-sm-offset-1 col-sm-2" for="organization_name">Organization Name : <span class="alert">*</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-offset-1 col-sm-2" for="address-line1">Address Line1 : <span class="alert">*</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-offset-1 col-sm-2" for="address-line2">Address Line2 : <span class="alert">*</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-offset-1 col-sm-2" for="address-line3">Address Line3 : <span class="alert">*</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-offset-1 col-sm-2" for="add_district">District : <span class="alert">*</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-offset-1 col-sm-2" for="firstname">Registrant Name : <span class="alert">*</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-offset-1 col-sm-2" for="designation">Registrant Designation : <span class="alert">*</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-offset-1 col-sm-2" for="dob_yrs">Date of Birth : <span class="alert">*</span></label>
								<div class="col-sm-4">
