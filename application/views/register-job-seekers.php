                    ...
                    <div class="login-container">
                        ...
                        <div id="seeker-signup" class="loginbox">
                            ...
                            <?php echo form_open('signup/seeker','id="form" class="reg_login_form"'); ?>
	                            <?php 
	                            if(isset($reg_server_msg)) :
	                            ?>
	                            <p class="val_status val_error db"> <?php echo $reg_server_msg; ?> </p>
	                            <?php
	                            else :
	                            ?>
	                            ...
	                            <div class="col-sm-6 pull-left">
			                        <?php echo ('<div class="form-group"> <label>Institution: <span class="required">*</span></label> <select name="candidate_institution_type" id="institution_type" class="form-control form_inputs">');?>
			                        <?php
