                            ...
                            <?php 
	                            ...
	                            <div class="col-sm-6 pull-left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(array('id' => 'organization_name','data-minlength' => '3','data-name' => 'Name' ,'maxlength' => '50','placeholder' => 'Name','class' => 'form-control form_inputs', 'name' => 'organization_name')); ?>
                                    </div>
                                    <div class="form-group">    
