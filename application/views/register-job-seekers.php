                        ...
                        <div class="login-container">
                            ...
                            <div id="seeker-signup" class="loginbox" >
                                ...
                                <div class="loginbox-title">Sign Up using social accounts</div>
                                	...
                                	<div class="loginbox-signin"> Already have account ?<a href="<?php echo base_url();?>login/seeker" class="txt_blue"> Sign in</a> </div>
                            </div> <!--End Signup-->
                            ...
                            <div id="seeker-signin" class="loginbox" style="display:none;">
                                ...
                                <div class="loginbox-signup">New User ?
                                    <a href="<?php echo site_url('signup/seeker');?>" class="txt_blue">Sign Up </a>
                                </div>
                            </div> <!--End SignIn-->
