            ...
            <div class="container-fluid">
                ...
                <div id="top_menu" class="nav notify-row">
                    ...
                    <ul class="nav top-menu">
                        <!-- BEGIN SETTINGS -->
                        <li class="dropdown">
                            <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="messengers.php#" data-original-title="Settings">
                                <i class="icon-cog"></i>
                            </a>
                        </li>
                        <!-- END SETTINGS -->
                        ...
                        <li class="dropdown" id="header_inbox_bar">
                            <a href="messengers.php#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu extended inbox">
                                ...
                                <li>
                                    <a href="messengers.php#">See all messages</a>
                                </li>
                            </ul>
                        </li>
                        <!-- END INBOX DROPDOWN -->
                        ...
                        <li class="dropdown" id="header_notification_bar">
                            ...
                            <ul class="dropdown-menu extended notification">
                                ...
                                <li>
                                    <a href="messengers.php#">See all notifications</a>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="top-nav ">
                    <ul class="nav pull-right top-menu" >
                        ...
                        <li class="dropdown mtop5">
                            ...
                            <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="messengers.php#" data-original-title="Chat">
                                <i class="icon-comments-alt"></i>
                            </a>
                        </li>
                        <li class="dropdown mtop5">
                            <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="messengers.php#" data-original-title="Help">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="messengers.php#"><i class="icon-user"></i> My Profile</a></li>
                                <li><a href="messengers.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                                <li><a href="messengers.php#"><i class="icon-calendar"></i> Calendar</a></li>
                                <li class="divider"></li>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
                        ...
                        <ul class="breadcrumb">
                            <li>
                                <a href="messengers.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                            </li>
                            <li><a href="messengers.php#">Components</a><span class="divider">&nbsp;</span></li>
                            <li><a href="messengers.php#">Conversations</a><span class="divider-last">&nbsp;</span></li>
                        </ul>
                                ...
                                <div class="widget-body">
                                    <div class="timeline-messages">
                                        ...
                                        <div class="msg-time-chat">
                                            <a href="messengers.php#" class="message-img"><img class="avatar" src="img/avatar1.jpg" alt=""></a>
                                            <div class="message-body msg-in">
                                                <div class="text">
                                                    <p class="attribution"><a href="messengers.php#">Mosaddek Hossain</a> at 1:55pm, 13th April 2013</p>
                                        ...
                                        <!-- Comment -->
                                        <div class="msg-time-chat">
                                            <a href="messengers.php#" class="message-img"><img class="avatar" src="img/avatar2.jpg" alt=""></a>
                                            <div class="message-body msg-out">
                                                <div class="text">
                                                    <p class="attribution"> <a href="messengers.php#">Dulal Khan</a> at 2:01pm, 13th April 2013</p>
                                        ...
                                        <div class="msg-time-chat">
                                            ...
                                            <div class="message-body msg-in">
                                                <div class="text">
                                                    <p class="attribution"><a href="messengers.php#">Mosaddek Hossain</a> at 2:03pm, 13th April 2013</p>
                                        ...
                                        <div class="msg-time-chat">
                                            ...
                                            <div class="message-body msg-out">
                                                <div class="text">
                                                    <p class="attribution"><a href="messengers.php#">Dulal Khan</a> at 2:05pm, 13th April 2013</p>
                                ...
                                <div class="widget-body">
                                    <ul class="chats">
                                        <li class="in">
                                            ...
                                            <div class="message">
                                                <span class="arrow"></span>
                                                <a href="messengers.php#" class="name">Mosaddek</a>
                                        ...
                                        <li class="out">
                                            ...
                                            <div class="message">
                                                <span class="arrow"></span>
                                                <a href="messengers.php#" class="name">Dulal Khan</a>
                                        ...
                                        <li class="in">
                                            ...
                                            <div class="message">
                                                <span class="arrow"></span>
                                                <a href="messengers.php#" class="name">Munshi Kamal</a>
