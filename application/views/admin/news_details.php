          ...
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="news.php">News</a></li>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                     News Details
                     <small>News details sample page</small>
                  </h3>
                   <ul class="breadcrumb">
                       <li>
                       ...
                       <li>
                           <a href="javascript:;">News</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="javascript:;">News Details</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
            ...
            <div class="row-fluid">
                        ...
                        <div class="widget-body">
                            <div class="row-fluid blog">
                                ...
                                <div class="span12">
                                    ...
                                    <img src="img/news/news-big-img.jpg" alt="">
                                    <div class="row-fluid">
                                        <div class="span6">
                                            <ul>
                                    ...
                                    <div class="media">
                                        <h3>Comments</h3>
                                        <hr>
                                        <a class="pull-left" href="news_details.php#">
                                            <img class="media-object" src="img/avatar1.jpg" alt="">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Mosaddek Hossain </h4>
                                            <span>2 hours ago | <a href="news_details.php#">Reply</a></span>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span>6 hours ago | <a href="news_details.php#">Reply</a></span>
                                                    <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                                                </div>
                                            </div>
                                            <!--end media-->
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="media-heading">Mosaddek Hossain </h4>
                                                    <span>9 days ago | <a href="news_details.php#">Reply</a></span>
                                                    <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                                                </div>
                                            </div>
                                            <!--end media-->
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">Dulal Khan </h4>
                                            <span>July 5,2013 | <a href="news_details.php#">Reply</a></span>
                                            <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                                        </div>
                                    </div>
                                    <!--end media-->
               ...
               <div class="span3">
                   <div class="blog-side-bar">
                       <h2>categories</h2>
                       <ul class="unstyled">
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i>  Sports</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> Funny</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> Finance</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> Travel</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> Fashion</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> Arts &amp; Artist</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> Technology</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> Crime</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> Life Style</a></li>
                       </ul>
                       <hr>
                       <h2>Latest news</h2>
                       ...
                       <h2>news ARCHIVES</h2>
                       <ul class="unstyled">
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> January 2013</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> February 2013 </a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> March 2013</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> April 2013</a></li>
                           <li><a href="news_details.php#"><i class="icon-chevron-right"></i> May 2013</a></li>
                       </ul>
                   </div>
               </div>
            </div>
