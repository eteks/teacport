           ...
           <div class="container-fluid">
               ...
               <div id="top_menu" class="nav notify-row">
                   ...
                   <ul class="nav top-menu">
                       <!-- BEGIN SETTINGS -->
                       <li class="dropdown">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="faq.php#" data-original-title="Settings">
                               <i class="icon-cog"></i>
                           </a>
                       </li>
                       <!-- END SETTINGS -->
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           <a href="faq.php#" class="dropdown-toggle" data-toggle="dropdown">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                   <a href="faq.php#">See all messages</a>
                               </li>
                           </ul>
                       </li>
                       <!-- END INBOX DROPDOWN -->
                       ...
                       <li class="dropdown" id="header_notification_bar">
                           ...
                           <ul class="dropdown-menu extended notification">
                               ...
                               <li>
                                   <a href="faq.php#">See all notifications</a>
                               </li>
                           </ul>
                       </li>
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown mtop5">
                           ...
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="faq.php#" data-original-title="Chat">
                               <i class="icon-comments-alt"></i>
                           </a>
                       </li>
                       <li class="dropdown mtop5">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="faq.php#" data-original-title="Help">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="faq.php#"><i class="icon-user"></i> My Profile</a></li>
                               <li><a href="faq.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                               <li><a href="faq.php#"><i class="icon-calendar"></i> Calendar</a></li>
                               <li class="divider"></li>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="faq.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                       </li>
                       <li>
                           <a href="faq.php#">Extra</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="faq.php#">FAQ Page</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="clearfix">
                                        <ul class="nav nav-list faq-list">
                                            <li>
                                                <a href="faq.php#" class="active"><i class=" icon-signin"></i> General Questions</a>
                                            </li>
                                            <li><a href="faq.php#"><i class="icon-pushpin"></i> Lorem Ipsum is simply dummy</a></li>
                                            <li><a href="faq.php#"><i class="icon-question-sign"></i> Contrary to popular belief</a></li>
                                            <li><a href="faq.php#"><i class="icon-briefcase"></i> There are many variation</a></li>
                                            <li><a href="faq.php#"><i class="icon-truck"></i> standard chunk of Lorem </a></li>
                                            <li><a href="faq.php#"><i class="icon-trophy"></i> Lorem Ipsum as their text</a></li>
                                            <li><a href="faq.php#"><i class="icon-leaf"></i> Lorem Ipsum as their default</a></li>
                                            <li><a href="faq.php#"><i class="icon-tags"></i>  Ipsum as default model text</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="span9">
                                    ...
                                    <div class="accordion" id="accordion">
                                        ...
                                        <div class="accordion-group">
                                          <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="faq.php#collapseOne">
                                        ...
                                        <div class="accordion-group">
                                          <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="faq.php#collapseTwo">
                                        ...
                                        <div class="accordion-group">
                                          <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="faq.php#collapseThree">
                                         ...
                                         <div class="accordion-group">
                                          <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="faq.php#collapseFour">
                                        ...
                                        <div class="accordion-group">
                                          <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="faq.php#collapseFive">
                                            Nihil anim keffiyeh helvetica, craft beer labore wes ?
                                            </a>
                                          </div>
                                        ...
                                        <div class="accordion-group">
                                          <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="faq.php#collapseSix">
                                            Nihil anim keffiyeh helvetica, craft beer labore wes ?
                                            </a>
                                          </div>
                                        ...
                                        <div class="accordion-group">
                                          <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="faq.php#collapseSeven">
                                        ...
                                        <div class="accordion-group">
                                          <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="faq.php#collapse8">
