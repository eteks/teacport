           ...
           <div class="container-fluid">
               ...
               <div id="top_menu" class="nav notify-row">
                   ...
                   <ul class="nav top-menu">
                       <!-- BEGIN SETTINGS -->
                       <li class="dropdown">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="form_component.php#" data-original-title="Settings">
                               <i class="icon-cog"></i>
                           </a>
                       </li>
                       <!-- END SETTINGS -->
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           <a href="form_component.php#" class="dropdown-toggle" data-toggle="dropdown">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                   <a href="form_component.php#">See all messages</a>
                               </li>
                           </ul>
                       </li>
                       <!-- END INBOX DROPDOWN -->
                       ...
                       <li class="dropdown" id="header_notification_bar">
                           ...
                           <ul class="dropdown-menu extended notification">
                               ...
                               <li>
                                   <a href="form_component.php#">See all notifications</a>
                               </li>
                           </ul>
                       </li>
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown mtop5">
                           ...
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="form_component.php#" data-original-title="Chat">
                               <i class="icon-comments-alt"></i>
                           </a>
                       </li>
                       <li class="dropdown mtop5">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="form_component.php#" data-original-title="Help">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="form_component.php#"><i class="icon-user"></i> My Profile</a></li>
                               <li><a href="form_component.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                               <li><a href="form_component.php#"><i class="icon-calendar"></i> Calendar</a></li>
                               <li class="divider"></li>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="form_component.php">Form Components</a></li>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="form_component.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                       </li>
                       <li>
                           <a href="form_component.php#">Form Stuff</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="form_component.php#">Form Components</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body form">
                        <!-- BEGIN FORM-->
                        <form action="form_component.php#" class="form-horizontal">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" action="form_component.php#">
                                <div class="control-group">
                            ...
                            <form action="form_component.php#" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       ...
                                       <input type="file" class="default" />
                                                ...
                                                <a href="form_component.php#" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <input type="file" class="default" />
                                            ...
                                            <span class="fileupload-preview"></span>
                                            <a href="form_component.php#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none">×</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-append">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="form_component.php#">Action</a></li>
                                                        <li><a href="form_component.php#">Another action</a></li>
                                                        <li><a href="form_component.php#">Something else here</a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="form_component.php#">Separated link</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
