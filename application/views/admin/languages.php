      ...
      <div class="row-fluid">
        ...
        <!-- BEGIN PAGE TITLE & BREADCRUMB-->     
          ...
          <ul class="breadcrumb">
            ...
            <li>
              <a href="<?php echo base_url(); ?>main/languages">Languages</a>
          ...
          <div class="widget">
            ...
            <div class="widget-body">
              <div class="portlet-body">
                ...
                <form method="post" action="languages" class="admin_module_form" id="languages_form">
                  <?php } ?>
                  <?php
                  if(!empty($status)) :
                        ...
                        <td>
                          ...
                          if(!empty($mapped_data)){
                            ...
                            if(count($mapped_result) > 0)
                              ...
                              echo "<a class='ajaxDelete' data-id='".$lan_val['language_id']."'>Delete</a>";
                          }
                          else{
                              echo "<a class='ajaxDelete' data-id='".$lan_val['language_id']."'>Delete</a>";
                          }
