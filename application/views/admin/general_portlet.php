...
<head>
   <meta charset="utf-8" />
   <title>General Portlet Page</title>
           ...
           <div class="container-fluid">
               ...
               <div id="top_menu" class="nav notify-row">
                   ...
                   <ul class="nav top-menu">
                       <!-- BEGIN SETTINGS -->
                       <li class="dropdown">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="general_portlet.php#" data-original-title="Settings">
                               <i class="icon-cog"></i>
                           </a>
                       </li>
                       <!-- END SETTINGS -->
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           <a href="general_portlet.php#" class="dropdown-toggle" data-toggle="dropdown">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                   <a href="general_portlet.php#">See all messages</a>
                               </li>
                           </ul>
                       </li>
                       <!-- END INBOX DROPDOWN -->
                       ...
                       <li class="dropdown" id="header_notification_bar">
                           ...
                           <ul class="dropdown-menu extended notification">
                               ...
                               <li>
                                   <a href="general_portlet.php#">See all notifications</a>
                               </li>
                           </ul>
                       </li>
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown mtop5">
                           ...
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="general_portlet.php#" data-original-title="Chat">
                               <i class="icon-comments-alt"></i>
                           </a>
                       </li>
                       <li class="dropdown mtop5">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="general_portlet.php#" data-original-title="Help">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="general_portlet.php#"><i class="icon-user"></i> My Profile</a></li>
                               <li><a href="general_portlet.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                               <li><a href="general_portlet.php#"><i class="icon-calendar"></i> Calendar</a></li>
                               <li class="divider"></li>
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      <li class="active"><a class="" href="general_portlet.php">General Portlets</a></li>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                     Portlets Page
                     <small>portlets page sample</small>
                  </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="general_portlet.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                       </li>
                       <li>
                           <a href="general_portlet.php#">Portlets</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="general_portlet.php#">General Portlets</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                ...
                <div class="span4 ">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            ...
                            <div class="actions">
                                <a href="general_portlet.php#" class="btn btn-success btn-mini"><i class="icon-pencil"></i> Edit</a>
                                <a href="general_portlet.php#" class="btn btn-primary btn-mini"><i class="icon-plus"></i> Add</a>
                            </div>
                        </div>
                ...
                <div class="span4 ">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Portlet</h4>
                            <div class="actions">
                                <a href="general_portlet.php#" class="btn btn-primary btn-mini"><i class="icon-pencil"></i> Edit</a>
                            </div>
                        </div>
                        <div class="widget-body">
                            ...
                            <div class="actions">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="general_portlet.php#">Action</a></li>
                                        <li><a href="general_portlet.php#">Another action</a></li>
                                        <li><a href="general_portlet.php#">Something else here</a></li>
                                        <li class="divider"></li>
                                        <li><a href="general_portlet.php#">Separated link</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="span6 ">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Portlet</h4>
                            <div class="actions">
                                <a href="general_portlet.php#" class="btn btn-success"><i class="icon-pencil"></i> Edit</a>
                                <a href="general_portlet.php#" class="btn btn-primary"><i class="icon-plus"></i> Add</a>
                            </div>
                        </div>
                        <div class="widget-body">
                            <div class="scroller" data-height="200px">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            ...
                            <div class="pagination pagination-small">
                                <ul>
                                    <li><a href="general_portlet.php#">«</a></li>
                                    <li><a href="general_portlet.php#">1</a></li>
                                    <li><a href="general_portlet.php#">2</a></li>
                                    <li><a href="general_portlet.php#">3</a></li>
                                    <li><a href="general_portlet.php#">»</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="widget-body">
                            <div class="tabbable widget-tabs">
                                <ul class="nav nav-tabs">
                                    <li><a href="general_portlet.php#widget_tab3" data-toggle="tab">Tab 3</a></li>
                                    <li><a href="general_portlet.php#widget_tab2" data-toggle="tab">Tab 2</a></li>
                                    <li class="active"><a href="general_portlet.php#widget_tab1" data-toggle="tab">Tab 1</a></li>
                                </ul>
                ...
                <div class="span4 ">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Portlet</h4>
                            <div class="actions">
                                <a href="general_portlet.php#" class="btn btn-success btn-mini"><i class="icon-share icon-black"></i> Share</a>
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn dropdown-toggle">Action <span class="caret"></span></button>
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="general_portlet.php#">Action</a></li>
                ...
                <div class="span8 ">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Portlet</h4>
                            <div class="actions">
                                <a href="general_portlet.php#" class="btn btn-primary btn-mini"><i class="icon-share"></i> Share</a>
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn dropdown-toggle">Action <span class="caret"></span></button>
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="general_portlet.php#">Action</a></li>
