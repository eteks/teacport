          ...
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="blog.php">Blog</a></li>
            ...
            <div class="row-fluid">
                            ...
                            <div class="row-fluid blog">
                                ...
                                <div class="span12">
                                    ...
                                    <div class="media">
                                        <h3>Comments</h3>
                                        <hr>
                                        <a class="pull-left" href="blog_details.php#">
                                            <img class="media-object" src="img/avatar1.jpg" alt="">
                                        </a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Mosaddek Hossain </h4>
                                            <span>2 hours ago | <a href="blog_details.php#">Reply</a></span>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span>6 hours ago | <a href="blog_details.php#">Reply</a></span>
                                                    <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                                                </div>
                                            </div>
                                            <!--end media-->
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="media-heading">Mosaddek Hossain </h4>
                                                    <span>9 days ago | <a href="blog_details.php#">Reply</a></span>
                                                    <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                                                </div>
                                            </div>
                                            <!--end media-->
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="media-heading">Dulal Khan </h4>
                                            <span>July 5,2013 | <a href="blog_details.php#">Reply</a></span>
                                            <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
                                        </div>
                                    </div>
                                    <!--end media-->
               ...
               <div class="span3">
                   <div class="blog-side-bar">
                       <h2>categories</h2>
                       <ul class="unstyled">
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i>  Animals</a></li>
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> Landscape</a></li>
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> Portait</a></li>
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> Wild Life</a></li>
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> Video</a></li>
                       </ul>
                       <hr>
                       ...
                       <ul class="unstyled tag">
                           <li><a href="blog_details.php#">Admin Panel</a></li>
                           <li><a href="blog_details.php#"> Dashboard Theme</a></li>
                           <li><a href="blog_details.php#"> Admin</a></li>
                           <li><a href="blog_details.php#"> Control Panel</a></li>
                           <li><a href="blog_details.php#"> UI</a></li>
                           <li><a href="blog_details.php#"> Web Design</a></li>
                           <li><a href="blog_details.php#"> UIX</a></li>
                           <li><a href="blog_details.php#"> Blog</a></li>
                       </ul>
                       <hr>
                       <h2>ARCHIVES</h2>
                       <ul class="unstyled">
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> January 2013</a></li>
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> February 2013 </a></li>
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> March 2013</a></li>
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> April 2013</a></li>
                           <li><a href="blog_details.php#"><i class="icon-chevron-right"></i> May 2013</a></li>
                       </ul>
                   </div>
               </div>
            </div>
