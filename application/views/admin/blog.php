            ...
            <div class="row-fluid">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="row-fluid blog">
                                ...
                                <div class="span8">
                                    ...
                                    <h2>
                                        <a href="blog_details.php">Suspendisse et mauris nisi, in semper justo.</a>
                                    </h2>
                                    <p>
                                    ...
                                    <a href="blog_details.php" class="btn btn-info">Continue Reading</a>
                                </div>
                            </div>
                            <hr>
                            <div class="row-fluid blog">
               ...
               <div class="span3">
                   <div class="blog-side-bar">
                       <h2>categories</h2>
                       <ul class="unstyled">
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i>  Animals</a></li>
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> Landscape</a></li>
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> Portait</a></li>
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> Wild Life</a></li>
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> Video</a></li>
                       </ul>
                       <hr>
                       ...
                       <ul class="unstyled tag">
                           <li><a href="blog.php#">Admin Panel</a></li>
                           <li><a href="blog.php#"> Dashboard Theme</a></li>
                           <li><a href="blog.php#"> Admin</a></li>
                           <li><a href="blog.php#"> Control Panel</a></li>
                           <li><a href="blog.php#"> UI</a></li>
                           <li><a href="blog.php#"> Web Design</a></li>
                           <li><a href="blog.php#"> UIX</a></li>
                           <li><a href="blog.php#"> Blog</a></li>
                       </ul>
                       <hr>
                       <h2>ARCHIVES</h2>
                       <ul class="unstyled">
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> January 2013</a></li>
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> February 2013 </a></li>
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> March 2013</a></li>
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> April 2013</a></li>
                           <li><a href="blog.php#"><i class="icon-chevron-right"></i> May 2013</a></li>
                       </ul>
                   </div>
               </div>
            </div>
