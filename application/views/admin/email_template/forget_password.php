	...
	<center>
		...
		<table width='600' background='#FFFFFF' style='text-align:left;' cellpadding='0' cellspacing='0'>
				...
				<tr>
					...
					<span style='font-size:25px; font-family:Trebuchet MS, Verdana, Arial; color:#29aafe;'><span ><img src="<?php echo base_url(); ?>assets/admin/img/teachers_recruit_logo.png"></span>&nbsp;Teachers Recruit</span>
					</td>
						...
						<table cellpadding='0' cellspacing='0'>
							<tr>
								...
								<td width='600' style='padding-right:10px; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;' valign='top'>
									<span style='font-family:Trebuchet MS, Verdana, Arial; font-size:17px; font-weight:bold;'>Hi <?php echo $admin_user_name; ?>!</span>
									<br />
									<p></p>
									<p style='font-size:15px'>You recently requested to forget your password for your teacher's recruit admin panel account. Below are your credentials: </p>
									<br />
									<table>
										<tr>
											<td><div style='padding-left:30px; padding-bottom:10px;color:#29aafe;'><img src='images/spade.gif' alt=''/>&nbsp;&nbsp;&nbsp;<span>Username:</span></div></td>
											<td><div style='padding-left:20px; padding-bottom:10px;color:#29aafe;'>&nbsp;&nbsp;&nbsp;<?php echo $admin_user_email; ?></div></td>	
										</tr>
										<tr>
											<td><div style='padding-left:30px; padding-bottom:10px;color:#29aafe;'><img src='images/spade.gif' alt=''/>&nbsp;&nbsp;&nbsp;<span >Password:</span></div></td>
											<td><div style='padding-left:20px; padding-bottom:10px;color:#29aafe;'>&nbsp;&nbsp;&nbsp;<?php echo $admin_user_password; ?></div></td>	
										</tr>		
									</table>	
									<p>You can <a href='<?php echo base_url()."main"; ?>' style="color:#29aafe;">return to website</a> to continue browsing.</p>
									<br/>
