           ...
           <div class="container-fluid">
               ...
               <div id="top_menu" class="nav notify-row">
                   ...
                   <ul class="nav top-menu">
                       <!-- BEGIN SETTINGS -->
                       <li class="dropdown">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="inbox.php#" data-original-title="Settings">
                               <i class="icon-cog"></i>
                           </a>
                       </li>
                       <!-- END SETTINGS -->
                       ...
                       <li class="dropdown" id="header_notification_bar">
                           ...
                           <ul class="dropdown-menu extended notification">
                               ...
                               <li>
                                   <a href="inbox.php#">See all notifications</a>
                               </li>
                           </ul>
                       </li>
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown mtop5">
                           ...
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="inbox.php#" data-original-title="Chat">
                               <i class="icon-comments-alt"></i>
                           </a>
                       </li>
                       <li class="dropdown mtop5">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="inbox.php#" data-original-title="Help">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="inbox.php#"><i class="icon-user"></i> My Profile</a></li>
                               <li><a href="inbox.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                               <li><a href="inbox.php#"><i class="icon-calendar"></i> Calendar</a></li>
                               <li class="divider"></li>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="inbox.php">Inbox</a></li>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   <h3 class="page-title">
                     Inbox Page
                     <small>inbox page sample</small>
                  </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="inbox.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                       </li>
                       <li>
                           <a href="inbox.php#"> Extra</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="inbox.php#">Inbox </a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                 ...
                 <div class="span12">
                     <div class="widget">
                         <div class="widget-title">
                             <h4><i class="icon-globe"></i>Inbox page</h4>
                           <span class="tools">
                                 ...
                                 <div class="span3">
                                     <div class="inbox-wraper inbox-option">
                                         <div class="inbox-header">
                                             ...
                                             <span class="username white-color">
                                                 <a href="inbox.php#">mosaddek@gmail.com</a>
                                             </span>
                                         </div>
                                         <div class="space15"></div>
                                         <ul class="inbox-nav margin-bottom-10">
                                             <li class="compose-btn">
                                                 <a href="javascript:;" data-title="Compose" class="btn btn-info  ">
                                                     Compose
                                                 </a>
                                             </li>
                                             <li class="inbox active">
                                                 <a href="javascript:;" class="" data-title="Inbox">Inbox(2)</a>
                                                 <b></b>
                                             </li>
                                             <li class="sent"><a class="" href="javascript:;"  data-title="Sent">Sent</a><b></b></li>
                                             <li class="draft"><a class="" href="javascript:;" data-title="Draft">Draft</a><b></b></li>
                                             <li class="trash"><a class="" href="javascript:;" data-title="Trash">Trash</a><b></b></li>
                                         </ul>
                                         <div class="space10"></div>
                                         <ul class="buddy-online">
                                             <h4>Buddy Online</h4>
                                             <li><span class="off-line"></span> <a href="inbox.php#">Jhone Doe</a><p>I do not think</p></li>
                                             <li><span class="online"></span><a href="inbox.php#"> Jonathan Smith</a><p>Available</p></li>
                                             <li><span class="busy"></span><a href="inbox.php#"> Mosaddek</a><p>Busy with coding</p></li>
                                             <li><span class="off-line"></span> <a href="inbox.php#">Dulal Doe</a><p>Away from Desk</p></li>
                                             <li><span class="off-line"></span> <a href="inbox.php#">Sumon jhon</a><p>On the way</p></li>
                                             <li><span class="off-line"></span> <a href="inbox.php#">Jhone Doe</a><p>I do not think</p></li>
                                         </ul>
                                         <div style="padding: 20px">
                                             <div class="btn-group">
                                                 <a class="btn mini blue" href="inbox.php#">
                                                     <i class="icon-plus"></i>
                                                 </a>
                                             </div>
                                             <div class="btn-group">
                                 ...
                                 <div class="span9">
                                    <div class="inbox-wraper">
                                        <div class="inbox-header">
                                         ...
                                         <form action="inbox.php#" class="form-search pull-right position">
