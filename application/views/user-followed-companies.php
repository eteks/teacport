	             	...
	             	<div class="featured-image-box">
	                    <div class="content-area">
	                        <div class="">
                                ...
                                <p> <i class="fa fa-clock-o"></i> <?php echo ($rec_val['vacancy_type'] == "full" ? "Full Time" : ($rec_val['vacancy_type'] == "part" ? "Part Time" : "Not Mentioned")); ?> </p>
	                        </div>
                	 ...
                	 <div class="widget">
                        ...
                        <ul class="related-post">
	                        ...
	                        <li>
                                ...
                                <p class="pull-right"> <i class="fa fa-clock-o"></i> <?php echo ($vac_val['vacancy_type'] == "full" ? "Full Time" : ($vac_val['vacancy_type'] == "part" ? "Part Time" : "Not Mentioned")); ?> </p>
