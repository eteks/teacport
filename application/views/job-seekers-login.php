                                ...
                                <?php echo form_open('signup/seeker','id="form" class="reg_login_form"'); ?>
                                	...
                                	<div class="col-sm-6 pull-left">
	                                	...
	                                	<div class="col-sm-6 captcha_holder nopadding">
	                                		<label>Enter Captcha value<sup class="alert">*</sup></label>
	                        				<?php echo form_input(array('id' => 'captcha_value','class' => 'form-control form_inputs','placeholder' => 'Captcha Value','name' => 'captcha_value')); ?>
	                        			</div>
	                        			<div class="clearfix"> </div>
	                        		</div>    
	                                <div class="loginbox-terms">
	                                   <label class="checkbox_word">
	                                   <?php echo form_input(array('type' => 'checkbox','value' => '1','name' => 'accept_terms', 'class' => 'form_dec')); ?> I accept <a href="register-4.html" class="txt_blue" target="_blank">Term and conditions?</a>
	                                </div>
	                                <div class="loginbox-submit">
