...
<body>
    <div class="page category-page">
        <div id="spinner">
            <div class="spinner-img"> <img alt="Opportunities Preloader" src="<?php echo base_url(); ?>images/loader.gif" />
                <h2>Please Wait.....</h2>
            </div>
        </div>
        <nav id="menu-1" class="mega-menu fa-change-black" data-color=""> 
         <section class="menu-list-items"> 
            ...
            <ul class="menu-links pull-right">
                ...
                <li><a href="<?php echo base_url(); ?>contact/">Contact<i class="fa fa-angle-down fa-indicator"></i></a></li>
