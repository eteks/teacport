		...
		<center>
			...
			<table width='600' background='#FFFFFF' style='text-align:left;' cellpadding='0' cellspacing='0'>
						...
						<tr>
							...
							<span style='color:#FFFFFF; font-size:18px; font-family:Trebuchet MS, Verdana, Arial;'>Subscription Details</span>
							</td>
						</tr>
									...
									<table cellpadding='0' cellspacing='0'>
										<tr>
											...
											<td width='600' style='padding-right:10px; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;' valign='top'>
												...
												<p style='font-size:15px'>Subscribed Plan Details are given below :</p>
												<br/>
												<table>
													<tr>
