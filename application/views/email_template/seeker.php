...
<title>Welcome Message/seeker</title>
</head>
<body>
<center>
...
<tr>
	...
	<br />
	<div style='padding-left:20px; padding-bottom:10px;color:#29aafe;'><img src='<?php echo base_url(); ?>assets/images/email_template/spade.gif' alt=''/>&nbsp;&nbsp;&nbsp;Username: <?php echo $candidate_email; ?> </div>
