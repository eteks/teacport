...
<html>
	<head>
		...
		<title>Grace Period Expired</title>
	</head>
	<body>
		<center>
			</br></br>
			<table width='600' background='#FFFFFF' style='text-align:left;' cellpadding='0' cellspacing='0'>
						...
						<tr>
							...
							<td background='' bgcolor='#29aafe' style='border-top:1px solid #FFF; border-bottom:1px solid #FFF; padding-left:15px;' height='80'>
								<span style='color:#FFFFFF; font-size:18px; font-family:Trebuchet MS, Verdana, Arial;'>Grace Period Expired </span>
							</td>
						</tr>
									...
									<table cellpadding='0' cellspacing='0'>
										<tr>
											...
											<td width='600' style='padding-right:10px; font-family:Trebuchet MS, Verdana, Arial; font-size:12px;' valign='top'>
												...
												<br/><br/>
												<p style='font-size:15px'>Your grace period for the plan <span style='font-size:16px;color:#da651a;'><b> <?php echo $subscription_name; ?> </b></span> has been expired.</p>
												<p style='font-size:15px'>Kindly renewal the plan to continue with our services.</p>												
