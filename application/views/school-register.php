...
<body>
    <div class="page category-page">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="login">
                            <div class="login_title">
                                ...
                                <p style="font-size: 22px; color: #fff;"><strong><i>Register New School</i></strong></p>
                            </div>
                            <div class="login_fields">
                                ...
                                <div class="login_fields_submit">
                                    <a href="school-login.php"><button class="btn btn-default" type="submit">Register</button></a>
                                    <div class="forgot">
                                        <a href="company-dashboard.php">Sign in</a>
                                    </div>
                                </div>
                            </div>
                            <div class="social">
        ...
        <a href="<?php echo base_url(); ?>register-2.html#" class="scrollup"><i class="fa fa-chevron-up"></i></a>
