...
require_once 'service/apiServiceRequest.php';
   ...
   *  </code>
   */
   if (!class_exists('UserinfoServiceResource')) {
   ...
   *  </code>
   */
      if (!class_exists('UserinfoV2ServiceResource')) {
   ...
   *  </code>
   */
     if (!class_exists('UserinfoV2MeServiceResource')) {
   ...
   *  </code>
   */
    if (!class_exists('TokeninfoServiceResource')) {
 ...
 * @author Google, Inc.
 */
   if (!class_exists('apiOauth2Service')) {
