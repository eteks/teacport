           ...
           <div class="container-fluid">
               ...
               <div id="top_menu" class="nav notify-row">
                   ...
                   <ul class="nav top-menu">
                       <!-- BEGIN SETTINGS -->
                       <li class="dropdown">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="basic_table.php#" data-original-title="Settings">
                               <i class="icon-cog"></i>
                           </a>
                       </li>
                       <!-- END SETTINGS -->
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           <a href="basic_table.php#" class="dropdown-toggle" data-toggle="dropdown">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                   <a href="basic_table.php#">See all messages</a>
                               </li>
                           </ul>
                       </li>
                       <!-- END INBOX DROPDOWN -->
                       ...
                       <li class="dropdown" id="header_notification_bar">
                           ...
                           <ul class="dropdown-menu extended notification">
                               ...
                               <li>
                                   <a href="basic_table.php#">See all notifications</a>
                               </li>
                           </ul>
                       </li>
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown mtop5">
                           ...
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="basic_table.php#" data-original-title="Chat">
                               <i class="icon-comments-alt"></i>
                           </a>
                       </li>
                       <li class="dropdown mtop5">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="basic_table.php#" data-original-title="Help">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="basic_table.php#"><i class="icon-user"></i> My Profile</a></li>
                               <li><a href="basic_table.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                               <li><a href="basic_table.php#"><i class="icon-calendar"></i> Calendar</a></li>
                               <li class="divider"></li>
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      <li class="active"><a class="" href="basic_table.php">Basic Table</a></li>
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                     Basic Tables
                     <small>Basic Table Samples</small>
                  </h3>
                   <ul class="breadcrumb">
                       <li>
                           <a href="basic_table.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                       </li>
                       <li>
                           <a href="basic_table.php#">Data Tables</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="basic_table.php#">Basic Tables</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                           ...
                           <tbody>
                              <tr>
                                 <td class="highlight">
                                    ...
                                    <a href="basic_table.php#">KLK</a>
                                 </td>
                                 <td class="hidden-phone"> Rafiq</td>
                                 <td>2560.60$</td>
                                 <td><a href="basic_table.php#" class="btn mini purple"><i class="icon-edit"></i> Edit</a></td>
                              </tr>
                              <tr>
                                 <td class="highlight">
                                    <div class="info"></div>
                                    <a href="basic_table.php#">BGF</a>
                                 </td>
                                 <td class="hidden-phone">Mosaddek </td>
                                 <td>560.60$</td>
                                 <td><a href="basic_table.php#" class="btn mini black"><i class="icon-trash"></i> Delete</a></td>
                              </tr>
                              <tr>
                                 <td class="highlight">
                                    <div class="important"></div>
                                    <a href="basic_table.php#">ABC</a>
                                 </td>
                              ...
                              <tr>
                                 <td class="highlight">
                                    ...
                                    <a href="basic_table.php#">DEF</a>
                                 </td>
                                 <td class="hidden-phone">DKMOS </td>
                                 <td>2560.60$</td>
                                 <td><a href="basic_table.php#" class="btn mini blue"><i class="icon-share"></i> Share</a></td>
                              </tr>
                              <tr>
                                  <td class="highlight">
                                      <div class="important"></div>
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body">
                         <table class="table table-striped table-bordered table-advance table-hover">
                             ...
                             <tbody>
                             <tr>
                                 <td><a href="basic_table.php#">Vector Ltd</a></td>
                                 <td class="hidden-phone">Lorem Ipsum dorolo imit</td>
                                 <td>12120.00$ <span class="label label-success label-mini">Due</span></td>
                                 <td><a href="basic_table.php#" class="btn mini green-stripe">View</a></td>
                             </tr>
                             <tr>
                                 <td>
                                     <a href="basic_table.php#">
                                 ...
                                 <td><a href="basic_table.php#" class="btn mini blue-stripe">View</a></td>
                             </tr>
                             <tr>
                                 <td>
                                     <a href="basic_table.php#">
                             ...
                             <tr>
                                 ...
                                 <td><a href="basic_table.php#" class="btn mini red-stripe">View</a></td>
                             </tr>
                             </tbody>
                         </table>
                     </div>
