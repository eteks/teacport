           ...
           <div class="container-fluid">
               ...
               <div id="top_menu" class="nav notify-row">
                   ...
                   <ul class="nav top-menu">
                       <!-- BEGIN SETTINGS -->
                       <li class="dropdown">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="editable_table.php#" data-original-title="Settings">
                               <i class="icon-cog"></i>
                           </a>
                       </li>
                       <!-- END SETTINGS -->
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           <a href="editable_table.php#" class="dropdown-toggle" data-toggle="dropdown">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                   <a href="editable_table.php#">See all messages</a>
                               </li>
                           </ul>
                       </li>
                       <!-- END INBOX DROPDOWN -->
                       ...
                       <li class="dropdown" id="header_notification_bar">
                           ...
                           <ul class="dropdown-menu extended notification">
                               ...
                               <li>
                                   <a href="editable_table.php#">See all notifications</a>
                               </li>
                           </ul>
                       </li>
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown mtop5">
                           ...
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="editable_table.php#" data-original-title="Chat">
                               <i class="icon-comments-alt"></i>
                           </a>
                       </li>
                       <li class="dropdown mtop5">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="editable_table.php#" data-original-title="Help">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="editable_table.php#"><i class="icon-user"></i> My Profile</a></li>
                               <li><a href="editable_table.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                               <li><a href="editable_table.php#"><i class="icon-calendar"></i> Calendar</a></li>
                               <li class="divider"></li>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="editable_table.php">Editable Table</a></li>
                  </ul>
              </li>
              <li class="has-sub">
                  <a href="javascript:;" class="">
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="editable_table.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                       </li>
                       <li>
                           <a href="editable_table.php#">Data Tables</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="editable_table.php#">Editable Table</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="editable_table.php#">Print</a></li>
                                            <li><a href="editable_table.php#">Save as PDF</a></li>
                                            <li><a href="editable_table.php#">Export to Excel</a></li>
                                        </ul>
                                    </div>
                                </div>
