            ...
            <div class="container-fluid">
                ...
                <div id="top_menu" class="nav notify-row">
                    ...
                    <ul class="nav top-menu">
                        <!-- BEGIN SETTINGS -->
                        <li class="dropdown">
                            <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="gallery.php#" data-original-title="Settings">
                                <i class="icon-cog"></i>
                            </a>
                        </li>
                        <!-- END SETTINGS -->
                        ...
                        <li class="dropdown" id="header_inbox_bar">
                            ...
                            <ul class="dropdown-menu extended inbox">
                                ...
                                <li>
                                    <a href="gallery.php#">See all messages</a>
                                </li>
                            </ul>
                        </li>
                        <!-- END INBOX DROPDOWN -->
                        ...
                        <li class="dropdown" id="header_notification_bar">
                            ...
                            <ul class="dropdown-menu extended notification">
                                ...
                                <li>
                                    <a href="gallery.php#">See all notifications</a>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="top-nav ">
                    <ul class="nav pull-right top-menu" >
                        ...
                        <li class="dropdown mtop5">
                            ...
                            <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="gallery.php#" data-original-title="Chat">
                                <i class="icon-comments-alt"></i>
                            </a>
                        </li>
                        <li class="dropdown mtop5">
                            <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="gallery.php#" data-original-title="Help">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="gallery.php#"><i class="icon-user"></i> My Profile</a></li>
                                <li><a href="gallery.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                                <li><a href="gallery.php#"><i class="icon-calendar"></i> Calendar</a></li>
                                <li class="divider"></li>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
                        ...
                        <ul class="breadcrumb">
                            <li>
                                <a href="gallery.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                            </li>
                            <li><a href="gallery.php#">Components</a><span class="divider">&nbsp;</span></li>
                            <li><a href="gallery.php#">Gallery</a><span class="divider-last">&nbsp;</span></li>
                        </ul>
								...
								<div class="widget-body">
									...
									<div class="row-fluid">
										<div class="span2">
											<div class="thumbnail">
												<div class="item">
													<a class="fancybox-button" data-rel="fancybox-button" title="Admin Lab photo" href="http://thevectorlab.net/adminlab/img/gallery/photo4.png">
														<div class="zoom">
															<img src="img/gallery/photo4.jpg" alt="Photo" />
															<div class="zoom-icon"></div>
														</div>
										...
										<div class="span2">
											<div class="thumbnail">
												<div class="item">
													<a class="fancybox-button" data-rel="fancybox-button" title="Admin Lab photo" href="http://thevectorlab.net/adminlab/img/gallery/photo5.png">
														<div class="zoom">
															<img src="img/gallery/photo5.jpg" alt="Photo" />
															<div class="zoom-icon"></div>
														</div>
                                        ...
                                        <div class="span2">
                                            <div class="thumbnail">
                                                <div class="item">
                                                    <a class="fancybox-button" data-rel="fancybox-button" title="Admin Lab photo" href="http://thevectorlab.net/adminlab/img/gallery/photo6.png">
                                                        <div class="zoom">
                                                            <img src="img/gallery/photo6.jpg" alt="Photo" />
                                                            <div class="zoom-icon"></div>
                                                        </div>
                                        ...
                                        <div class="span2">
                                            <div class="thumbnail">
                                                <div class="item">
                                                    <a class="fancybox-button" data-rel="fancybox-button" title="Admin Lab photo" href="http://thevectorlab.net/adminlab/img/gallery/photo7.png">
                                                        <div class="zoom">
                                                            <img src="img/gallery/photo7.jpg" alt="Photo" />
                                                            <div class="zoom-icon"></div>
                                                        </div>
										...
										<div class="span12">
											<div class="pagination text-center">
												<ul>
													...
													<li><a href="gallery.php#">2</a></li>
													<li><a href="gallery.php#">3</a></li>
													<li><a href="gallery.php#">4</a></li>
