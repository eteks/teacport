...
<body id="login-body">
  ...
  <div id="login">
    <!-- BEGIN LOGIN FORM -->
    <form id="loginform" class="form-vertical no-padding no-margin" action="index.php">
      <div class="lock">
          <i class="icon-lock"></i>
      </div>
    ...
    <form id="forgotform" class="form-vertical no-padding no-margin hide" action="index.php">
