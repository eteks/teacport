               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="javascript:;">News Page</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
            ...
            <div class="row-fluid">
               <div class="span9">
                  <div class="widget">
                        <div class="widget-title">
                           <h4><i class="icon-edit"></i> Latest News</h4>
                           <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="row-fluid blog">
                                <div class="span8 news">
                                    ...
                                    <h2>
                                        <a href="news_details.php">Suspendisse et mauris nisi, in semper justo.</a>
                                    </h2>
                                    <p>
                                        February 7, 2013 by  <a href="javascript:;">Jonathon Smith</a>
                                    </p>
                                    <p>
                                    ...
                                    <a href="news_details.php" class="btn btn-info">Continue Reading</a>
                                </div>
                                <div class="span4 news">
                                    <a href="news.php#" class="view">View All News</a>
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span9">
                                            ...
                                            <p>February 7, 2013 by <a href="news.php#">Jonathon Smith</a></p>
                                        </div>
                                    </div>
               ...
               <div class="span3">
                   <div class="blog-side-bar">
                       <h2>categories</h2>
                       <ul class="unstyled">
                           <li><a href="news.php#"><i class="icon-chevron-right"></i>  Sports</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> Funny</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> Finance</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> Travel</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> Fashion</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> Arts & Artist</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> Technology</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> Crime</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> Life Style</a></li>
                       </ul>
                       <hr>
                       <h2>Latest news</h2>
                       ...
                       <div class="row-fluid">
                           <div class="span3">
                               <img src="img/news/news-thumb-1.jpg" alt="">
                           </div>
                           <div class="span9">
                               <h5>
                                   <a href="javascript:;">Worldwide 10 Restaurants</a>
                       ...
                       <div class="row-fluid">
                           <div class="span3">
                               <img src="img/news/news-thumb-2.jpg" alt="">
                           </div>
                           <div class="span9">
                               <h5>
                                   <a href="javascript:;">Worldwide 10 Restaurants</a>
                       ...
                       <div class="row-fluid">
                           <div class="span3">
                               <img src="img/news/news-thumb-3.jpg" alt="">
                           </div>
                           <div class="span9">
                               <h5>
                                   <a href="javascript:;">Worldwide 10 Restaurants</a>
                       ...
                       <h2>news ARCHIVES</h2>
                       <ul class="unstyled">
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> January 2013</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> February 2013 </a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> March 2013</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> April 2013</a></li>
                           <li><a href="news.php#"><i class="icon-chevron-right"></i> May 2013</a></li>
                       </ul>
                   </div>
               </div>
            </div>
