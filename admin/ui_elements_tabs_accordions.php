           ...
           <div class="container-fluid">
               ...
               <div id="top_menu" class="nav notify-row">
                   ...
                   <ul class="nav top-menu">
                       <!-- BEGIN SETTINGS -->
                       <li class="dropdown">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="ui_elements_tabs_accordions.php#" data-original-title="Settings">
                               <i class="icon-cog"></i>
                           </a>
                       </li>
                       <!-- END SETTINGS -->
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           <a href="ui_elements_tabs_accordions.php#" class="dropdown-toggle" data-toggle="dropdown">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                   <a href="ui_elements_tabs_accordions.php#">
                               ...
                               <li>
                                   <a href="ui_elements_tabs_accordions.php#">See all messages</a>
                               </li>
                           </ul>
                       </li>
                       <!-- END INBOX DROPDOWN -->
                       ...
                       <li class="dropdown" id="header_notification_bar">
                           ...
                           <ul class="dropdown-menu extended notification">
                               ...
                               <li>
                                   <a href="ui_elements_tabs_accordions.php#">See all notifications</a>
                               </li>
                           </ul>
                       </li>
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown mtop5">
                           ...
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="ui_elements_tabs_accordions.php#" data-original-title="Chat">
                               <i class="icon-comments-alt"></i>
                           </a>
                       </li>
                       <li class="dropdown mtop5">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="ui_elements_tabs_accordions.php#" data-original-title="Help">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="ui_elements_tabs_accordions.php#"><i class="icon-user"></i> My Profile</a></li>
                               <li><a href="ui_elements_tabs_accordions.php#"><i class="icon-tasks"></i> My Tasks</a></li>
                               <li><a href="ui_elements_tabs_accordions.php#"><i class="icon-calendar"></i> Calendar</a></li>
                               <li class="divider"></li>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="has-sub active">
                  ...
                  <ul class="sub">
                      ...
                      <li class="active"><a class="" href="ui_elements_tabs_accordions.php">Tabs & Accordions</a></li>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       <li>
                           <a href="ui_elements_tabs_accordions.php#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                       </li>
                       <li>
                           <a href="ui_elements_tabs_accordions.php#">UI Elements</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="ui_elements_tabs_accordions.php#">Tabs & Accordions</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                        ...
                        <div class="widget-body">
                           <div class="tabbable portlet-tabs">
                              <ul class="nav nav-tabs">
                                 <li><a href="ui_elements_tabs_accordions.php#portlet_tab3" data-toggle="tab">Tab 3</a></li>
                                 <li><a href="ui_elements_tabs_accordions.php#portlet_tab2" data-toggle="tab">Tab 2</a></li>
                                 <li class="active"><a href="ui_elements_tabs_accordions.php#portlet_tab1" data-toggle="tab">Tab 1</a></li>
                              </ul>
                           ...
                           <div class="accordion" id="accordion1">
                              <div class="accordion-group">
                                 <div class="accordion-heading">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="ui_elements_tabs_accordions.php#collapse_1">
                                    <i class=" icon-plus"></i>
                              ...
                              <div class="accordion-group">
                                 <div class="accordion-heading">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="ui_elements_tabs_accordions.php#collapse_2">
                                    <i class=" icon-plus"></i>
                              ...
                              <div class="accordion-group">
                                 <div class="accordion-heading">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="ui_elements_tabs_accordions.php#collapse_3">
                                    <i class=" icon-plus"></i>
                               ...
                               <div class="accordion-group">
                                   <div class="accordion-heading">
                                       <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="ui_elements_tabs_accordions.php#collapse_4">
                                           <i class=" icon-plus"></i>
                           ...
                           <div class="row-fluid">
                              <div class="span6">
                                 ...
                                 <div class="tabbable tabbable-custom">
                                    <ul class="nav nav-tabs">
                                       <li class="active"><a href="ui_elements_tabs_accordions.php#tab_1_1" data-toggle="tab">Section 1</a></li>
                                       <li><a href="ui_elements_tabs_accordions.php#tab_1_2" data-toggle="tab">Section 2</a></li>
                                       <li><a href="ui_elements_tabs_accordions.php#tab_1_3" data-toggle="tab">Section 3</a></li>
                                    </ul>
                                    <div class="tab-content">
                              ...
                              <div class="span6">
                                 ...
                                 <div class="tabbable tabbable-custom tabs-below">
                                    ...
                                    <ul class="nav nav-tabs">
                                       <li class="active"><a href="ui_elements_tabs_accordions.php#tab_2_1" data-toggle="tab">Section 1</a></li>
                                       <li><a href="ui_elements_tabs_accordions.php#tab_2_2" data-toggle="tab">Section 2</a></li>
                                       <li><a href="ui_elements_tabs_accordions.php#tab_2_3" data-toggle="tab">Section 3</a></li>
                                    </ul>
                                 </div>
                                 <!--END TABS-->
                              </div>
                                   ...
                                   <div class="span6">
                                       ...
                                       <div class="tabbable tabbable-custom tabs-left">
                                           ...
                                           <ul class="nav nav-tabs tabs-left">
                                               <li class="active"><a href="ui_elements_tabs_accordions.php#tab_3_1" data-toggle="tab">Section 1</a></li>
                                               <li><a href="ui_elements_tabs_accordions.php#tab_3_2" data-toggle="tab">Section 2</a></li>
                                               <li><a href="ui_elements_tabs_accordions.php#tab_3_3" data-toggle="tab">Section 3</a></li>
                                           </ul>
                                           <div class="tab-content">
                                   ...
                                   <div class="span6">
                                       ...
                                       <div class="tabbable tabbable-custom tabs-right">
                                           ...
                                           <ul class="nav nav-tabs tabs-right">
                                               <li class="active"><a href="ui_elements_tabs_accordions.php#tab_4_1" data-toggle="tab">Section 1</a></li>
                                               <li><a href="ui_elements_tabs_accordions.php#tab_4_2" data-toggle="tab">Section 2</a></li>
                                               <li><a href="ui_elements_tabs_accordions.php#tab_4_3" data-toggle="tab">Section 3</a></li>
                                           </ul>
                                           <div class="tab-content">
